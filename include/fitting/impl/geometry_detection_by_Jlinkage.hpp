#ifndef _Geometry_DETECTION_By_JLinkage_HPP_Tony_Sep_21_2016_
#define _Geometry_DETECTION_By_JLinkage_HPP_Tony_Sep_21_2016_
...
int geometry_detect_by_JLinkage(pcl::PointCloud<PointT> &cloud, std::vector<std::vector<int>> &clusters, geoModelType modelType,
	float mInlierThreshold, int nDNeigh, float nPClose, float nPFar, int nSampleModels)
{
	// Function pointers
	...
	else if(modelType == geoModel_plane)
	{
		nPtDimension = 3;
		nMSS = 3;
